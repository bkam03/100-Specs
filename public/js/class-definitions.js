...
Vehicle.prototype.drive = function( streetName ){
  var isValidStreet = ( typeof streetName === 'string' ) && streetName !== '';
  var action = null;
  if( isValidStreet ){
    action = `Driving on ${ streetName }`;
  } else {
...
Shape.prototype.getType = function (){
  ...
  switch( this.sides ){
    ...
    case 10:
      ...
      break;
    default:
      shapeType = 'Could not determine type';
      break;
  }
  return shapeType;
};
 ...
 */
 ...
 Box.prototype.openBox = function (){
  isOpenedWithFunction = false;

  if( this.isOpen === false ){
    this.isOpen = true;
    isOpenedWithFunction = true;
  }

  return isOpenedWithFunction;
 };
...
var notWarmOrColdAnimal = new Animal( 'Bacteria', 'n/a' ).isWarmBlooded();
...
var polygon = new Shape( 123 ).getType();
 ...
 *
 */
var badForYou = new Meal( [ 'bacon', 'chips' ] ).containsJunkFood();
